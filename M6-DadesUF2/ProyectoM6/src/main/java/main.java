...
public class main {
	...
	public static void main(String[] args) {
		...
		try {
			// una sesion es una conexión a la BD. Pueden haber varias sesiones simultaneas
			...
			// Una transaccion es atómica. Solo puede haber una y hasta que no se cierra no
